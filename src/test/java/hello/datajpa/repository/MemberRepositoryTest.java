...
class MemberRepositoryTest {
    ...
    public void paging(){
        ...
        // controller에서 entity 접근하면 안됨. dto 로 변환해야함
        Page<MemberDto> toMap = page.map(member -> new MemberDto(member.getId(), member.getUsername(), null));


        // then
        List<Member> content = page.getContent(); // 목표 했던 데이터 꺼내옴
    ...
    public void slicing(){
        // slice = page + 1 그래서 요즘에 더보기.. 누르면 다음 데이터 뜨게 미리 로딩 해둘 때 많이 씀
        ...
        assertThat(content.size()).isEqualTo(3);
//        assertThat(page.getTotalElements()).isEqualTo(5); // total count 날리지 않음
        assertThat(page.getNumber()).isEqualTo(0);
//        assertThat(page.getTotalPages()).isEqualTo(2);
        assertThat(page.isFirst()).isTrue();
        assertThat(page.hasNext()).isTrue();
